...
#pragma warning restore CS0612
            ...
            string data = HexConverter.FromHexString(response.Values.Sa.FirstOrDefault());
...
#pragma warning restore CS0612
            ...
            data = HexConverter.FromHexString(response.Values.Sa.FirstOrDefault());
...
#pragma warning restore CS0612
        ...
        private void AddEntryInternal(string id, string data, bool allowOverwrite)
        {
            ...
            {
                query = $"INSERT INTO {tableName} (id, dt, ts) VALUES ('{id}', '{HexConverter.ToHexString(data)}', '{timestamp}') IF NOT EXISTS";
            }
...
#pragma warning restore CS0612
        ...
        {
            string query = $"UPDATE {tableName} SET dt = '{HexConverter.ToHexString(data)}' WHERE id = '{id}' IF EXISTS";
